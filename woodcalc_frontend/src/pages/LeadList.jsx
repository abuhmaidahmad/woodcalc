    ...
    <div style={{ minHeight: '100vh', background: '#F7F4F0', fontFamily: "'Inter', sans-serif" }}>
      <div style={{ height: 56, background: DARK, display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 24px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
          ...
          <span style={{ color: '#fff', fontWeight: 600, fontSize: 14 }}>Leads</span>
        </div>
      ...
      <div style={{ maxWidth: 900, margin: '0 auto', padding: 24 }}>
        <div style={{ marginBottom: 20 }}>
          <h1 style={{ margin: 0, fontSize: 24, fontWeight: 800, color: DARK }}>Leads</h1>
          <div style={{ color: '#888', fontSize: 13, marginTop: 2 }}>{leads.length} total</div>
        </div>
        ...
        {loading ? (
          ...
          <div style={{ textAlign: 'center', padding: 40, color: '#bbb' }}>
            ...
            <div style={{ fontSize: 12, marginTop: 4 }}>Leads captured from your public catalog will show up here</div>
          </div>
        ) : (
              ...
              <div key={l.id}
                ...
                <div>
                  ...
                  <div style={{ fontSize: 12, color: '#888', marginTop: 2 }}>
                    ...
                    {cabinetCount(l) > 0 && (
                      <> · 🗄 {cabinetCount(l)} cabinet{cabinetCount(l) === 1 ? '' : 's'}{l.design_total ? ` · ${l.design_total}` : ''}</>
                    )}
                  </div>
                </div>
