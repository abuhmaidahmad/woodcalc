...
class Supplier(models.Model):
    ...
    tenant = models.ForeignKey(Company, on_delete=models.CASCADE, related_name='suppliers')
...
class Sink(models.Model):
    ...
    tenant = models.ForeignKey(Company, on_delete=models.CASCADE, related_name='sinks')
    brand = models.CharField(max_length=100, blank=True, default='')
